...
function Client() {
  ...
  const handleFormSubmit = (event) => {
    ...
    if (editId) {
      ...
      axios.put(`http://127.0.0.1:8000/api/updateclient/${editId}`, data)
        .then(response => {
      ...
      axios.post('http://127.0.0.1:8000/api/insertClient', data)
        .then(response => {
          console.log('Response:', response);
            ...
            <a className="nav-link active nav-itemcollapsed" data-bs-toggle="collapse" href="#people-list" >
              <i className="me-2"><FontAwesomeIcon icon={faList} /></i>People<i className="bi bi-chevron-down mt-2" style={{ marginTop: "2px" }} ></i>        
                   ...
                   <ul id="people-list" className="nav-content collapse" data-bs-parent="#sidebar-nav">
                      ...
                      <Link to="/Client" className="nav-item nav-link active" >
        ...
        <div className="container-fluid pt-4 px-4">
          <div className="bg-light text-center rounded p-4">
            ...
            <Modal show={show} onHide={handleClose}>
              ...
              <Modal.Title>{editId ? 'Edit user' : 'Create Client'}</Modal.Title>
              </Modal.Header>
              <Modal.Body>
                <Form onSubmit={handleFormSubmit}>
                  ...
                  <div className="mb-3">
                    <label htmlFor="Date" className="form-label">Location</label>
                    <input type="text" className="form-control" id="location" name="location" value={location} onChange={handleChange} required />
                  </div>
                  <div className="mb-3">
                    <label htmlFor="Date" className="form-label">Role </label>
                    <input type="text" className="form-control" id="role" name="role" value={role} onChange={handleChange} required />
                  </div>
                  <div className="mb-3">
                    <label htmlFor="text" className="form-label">Deals:</label>
                    <input type="text" className="form-control" id="deals" name="deals" value={deals} onChange={handleChange} required />
                  </div>
                  <div className="mb-3">
                    <label htmlFor="email" className="form-label">Project:</label>
