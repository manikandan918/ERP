...
useEffect(()=>{
  ...
  useEffect(() => {
    axios.get('http://127.0.0.1:8000/api/salesorders')
  ...
  const handleFormSubmit = (event) => {
    ...
    if (editId) {
      ...
      axios.put(`http://127.0.0.1:8000/api/updatesalesorder/${editId}`, data)
        .then(response => {
      ...
      axios.post('http://127.0.0.1:8000/api/insertsalesorders', data)
        .then(response => {
          console.log('Response:', response);
        ...
        const handleDelete = (id) => {
          axios.delete(`http://127.0.0.1:8000/api/deleteinventory/${id}`)
              .then(() => {
      ...
      const handleEdit = (id) => {
        ...
        if (selectedPost) {
          ...
          setcreated_at(selectedPost.created_at);
            ...
            <a className="nav-link active nav-itemcollapsed" data-bs-toggle="collapse" href="#warehouse-list" >
              <i className="me-2"><FontAwesomeIcon icon={ faWarehouse} /></i>Warehousing<i className="bi bi-chevron-down mt-2" style={{ marginTop: "2px" }} ></i>        
                   ...
                   <ul id="warehouse-list" className="nav-content collapse" data-bs-parent="#sidebar-nav">
                      ...
                      <Link to="/Salesorder" className="nav-item nav-link active" >
          ...
          <div className="container-fluid pt-4 px-4">
            <div className="bg-light text-center rounded p-4">
              <div className="d-flex align-items-center justify-content-between mb-4">
                <h6 className="mb-0">Sales order List</h6>
              ...
              <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Title>{editId ? 'Edit Salesorder' : 'Create salesorder'}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                  <Form onSubmit={handleFormSubmit}>
                    ...
                    <div className="mb-3">
                      <label htmlFor="Invoice" className="form-label">Modification:</label>
                      <input type="text" className="form-control" id="created_at" name="created_at" value={created_at} onChange={handleChange} required />
                    </div>
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                      <label htmlFor="phone" className="form-label">Total:</label>
