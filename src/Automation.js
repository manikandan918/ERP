...
// dropdown function
  ...
  const [inputs, setInputs] = useState({ workname: "", tag: "", file: "",});
  ...
  const handleFormSubmit = (event) => {
    ...
    axios.post('http://127.0.0.1:8000/api/insertautomations', data)
      .then(response => {
  ...
  return (
      ...
      <nav className="navbar bg-light navbar-light">
        ...
        <div className="navbar-nav w-100">
          ...
          <li className="nav-item">
           ...
           <Link to="/Automation" className="nav-item nav-link active">
    ...
    <div className="col-sm-12 col-xl-6 mx-auto">
        <div className="bg-light rounded h-100 p-4">
            <h6 className="mb-4 text-center">Add Workflow</h6>
            <form action="" onSubmit={handleFormSubmit}>
                <div className="mb-3">
                    <label htmlFor="firstname" className="form-label">workname:</label>
                    <input type="text" className="form-control" id="workname" name="workname" value={inputs.workname} onChange={handleChange} required />
                </div>
                <div className="mb-3">
                    <label htmlFor="lastname" className="form-label">Tag:</label>
                    <input type="text" className="form-control" id="tag" name="tag" value={inputs.tag} onChange={handleChange} required />
                </div>
                <div className="mb-3">
                    <label htmlFor="email" className="form-label">Document:</label>
                    <input type="file" className="form-control" id="file" name="file" value={inputs.email} onChange={handleChange} required />
