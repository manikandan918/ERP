   ...
   const handleSidebarToggle = () => {
    ...
    return(
      ...
      <nav className="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
            ...
            <h3 className="mb-0 text-center">Database</h3>
              ...
              <div className="table-responsive">
                <table className="table text-start align-middle table-bordered table-hover mb-0">
                  <thead>
                    ...
                    <th scope="col" >LeadSource</th>
                    <th scope="col" >Notes</th>
                    <th scope="col" className="me-2">Action</th>
                    <th scope="col" className="me-2">Action</th>
                    </tr>
                  </thead>
                  <tbody>
                    {posts.map((post, index) => (
                      <tr key={index}>
                       ...
                       <td>{post.id}</td>
                        ...
                        <td>{post.industry}</td>
                        <td>{post.address}</td>
                        <td>{post.leadsource}</td>
                        <td>{post.notes}</td>
                        <td>
                        <Link to={"edit/" + post.id} className="btn btn-sm btn-warning ms-4 "><FontAwesomeIcon icon={faPencilAlt} /></Link></td>
                          <td><button onClick={() => handleDelete(post.id)} className="btn btn-sm btn-danger "><FontAwesomeIcon icon={faTrashAlt} /></button></td>
...
export default Table;
    ...
    {/* <div className="bg-light ">
        <center><b className="mt-4 ">Database</b></center>
        <table className="table table-hover mt-5">
            <thead>
                <tr>
                    <th scope="col" className ="me-2" style={{ width: "50px" }}>ID</th>
                    <th scope="col" style={{ width: "600px" }}>FirstName</th>
                    <th scope="col" style={{ width: "600px" }}>LastName</th>
                    <th scope="col" style={{ width: "150px" }}>Email</th>
                    <th scope="col" style={{ width: "100px" }}>Phone</th>
                    <th scope="col" style={{ width: "150px" }}>Company</th>
                    <th scope="col" style={{ width: "150px" }}>JobTitle</th>
                    <th scope="col" style={{ width: "150px" }}>Industry</th>
                    <th scope="col" style={{ width: "150px" }}>Address</th>
                    <th scope="col" style={{ width: "400px" }}>LeadSource</th>
            ...
            {posts.map((post,index) => { return (
                    <tr key={index}>
                        ...
                        <td style={{ width: "120px" }}>
                           <Link to={"edit/" + post.id} className="btn btn-sm btn-warning  "><FontAwesomeIcon icon={faTrashAlt} /></Link></td>
                           
                          <td><button onClick={() => handleDelete(post.id)} className="btn btn-sm btn-warning "><FontAwesomeIcon icon={faTrashAlt} /></button></td>
